...
const styles = {
    ...
    title: { fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: '800', marginBottom: '15px', color: '#fff', letterSpacing: '-2px', lineHeight: '1.1' },
    ...
    searchContainer: {
        ...
        background: 'rgba(20,20,30,0.8)', // Более плотный фон вместо тяжелого blur
    ...
    button: { background: '#F43F5E', color: '#fff', border: 'none', padding: '0 30px', borderRadius: '12px', fontWeight: '800', cursor: 'pointer', fontSize: '1rem', transition: 'all 0.2s' },
...
export const SearchHeader = ({ query, setQuery, onSearch, filters, setFilters, onGoHome }) => (
    <>
        ...
        <div style={styles.hero}>
            <h1 style={styles.title}>Смотри аниме<br /><span style={{ color: 'transparent', WebkitTextStroke: '1px rgba(255,255,255,0.5)' }}>без лагов.</span></h1>
            <p style={styles.subtitle}>Легкий, быстрый, твой.</p>
